...
(1, 'Andrea', 'Visintin', 'a.visintin@uniud.it', 'www.uniud.it/avisintin'),
(2, 'Chiara', 'Furlan', 'c.furlan@uniud.it', 'www.uniud.it/cfurlan'),
(3, 'Marco', 'Zanon', 'm.zanon@uniud.it', 'www.uniud.it/mzanon'),
(4, 'Giulia', 'Morandini', 'g.morandini@uniud.it', 'www.uniud.it/gmorandini'),
(5, 'Stefano', 'Mattioli', 's.mattioli@uniud.it', 'www.uniud.it/smattioli'),
...
SELECT codice, (codice % 40) + 1 FROM public.pubblicazione;

-- Secondo autore (assegnato solo se il codice e pari)
INSERT INTO public.pubb_autore (codice_pubblicazione, id_autore)
SELECT codice, ((codice + 1) % 40) + 1 FROM public.pubblicazione WHERE codice % 2 = 0;

-- Terzo autore (assegnato solo se il codice e divisibile per 3)
INSERT INTO public.pubb_autore (codice_pubblicazione, id_autore)
SELECT codice, ((codice + 2) % 40) + 1 FROM public.pubblicazione WHERE codice % 3 = 0;
...
\begin{table}[H]
\centering
\caption{Dettagli delle Affiliazioni Universitarie}
\begin{tabular}{cccc}
\toprule
...
Università di Trieste & 0432-556112 & Piazzale Europa 1, Trieste & Università \\
\bottomrule
\end{tabular}
\end{table}
